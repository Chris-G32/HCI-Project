...
namespace HCI_Project.MVVM.Model.Database
{
    public class DatabaseFactory
    {
        ...
        public static void BuildTables(SQLiteCommand cmd)
        {
            ...
            cmd.CommandText = @"CREATE TABLE games(id varchar(20) PRIMARY KEY, name varchar(50), launcher_id INTEGER, description TEXT, header_image_link TEXT, screenshots_folder TEXT, discord_link TEXT)";
            cmd.ExecuteNonQuery();
