...
namespace HCI_Project.MVVM.Model.Database
{
    public class DatabaseManager
    {
        ...
        public void InsertGame(Game game)
        {
            ...
            _cmd.CommandText = $"INSERT INTO games (id, name, launcher_id, description, header_image_link, icon_image_link, short_desc, playtime) VALUES ('{game.Game_ID}', '{game.Name}', {(int) game.Launcher_ID}, '{game.Description + " "}', '{game.HeaderImage.ToString()}', '{game.IconImage.ToString()}', '{game.Short_Description}', {game.Playtime_Hours})";
            _cmd.ExecuteNonQuery();
